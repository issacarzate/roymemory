export class NumeroALetras  {
  ...
  NumeroALetras(num, currency) {
      ...
      if (data.centavos > 0) {
          ...
          if (data.centavos == 1)
              data.letrasCentavos += this.Millones(data.centavos) + ' ' + data.letrasMonedaCentavoSingular;
          else
              data.letrasCentavos += this.Millones(data.centavos) + ' ' + data.letrasMonedaCentavoPlural;
